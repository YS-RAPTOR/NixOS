...
in {
  wayland.windowManager.hyprland = {
    ...
    settings = {
      monitor = "eDP-1,3200x2000@120.00Hz,auto,1.6";
      # exec-once = [
      ...
      bind = [
        ...
        # Screenshot active
        "$mainMod SHIFT, S, exec, hyprshot -m active"
        # Screenshot a monitor
        " , PRINT, exec, hyprshot -m output"
        # Screenshot a window
        "CONTROL, PRINT, exec, hyprshot -m window"
        # Screenshot a region
      ...
      bindel = [
        ...
        ",XF86MonBrightnessUp, exec, brightnessctl -e -d intel_backlight set 5%+ && brightnessctl -e -d nvidia_0 set 5%+"
        ",XF86MonBrightnessDown, exec, brightnessctl -e -d intel_backlight set 5%- && brightnessctl -e -d nvidia_0 set 5%-"
      ];
