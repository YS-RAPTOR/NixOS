{
  ...
  outputs = inputs@{ self, affinity-nix, ... }:
    let
      profile = "home";
      ...
      lib = if settings.system.unstable then
        inputs.nixpkgs-unstable.lib
      else
        inputs.nixpkgs-stable.lib;

      home-manager = if settings.system.unstable then
      ...
      stylix = if settings.system.unstable then
        inputs.stylix-unstable
      else
        inputs.stylix-stable;
